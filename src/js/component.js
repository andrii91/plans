...
$(document).ready(function () {
  var containerCarousel = $('#container-carousel');
  ...
  $('.arr-left').click(function () {
    containerCarousel.trigger('prev.owl.carousel');
  })
  ...
  $('.container-carousel>.owl-dots .owl-dot span').each(function (index) {
    var $itemTitle = $($('.container-carousel>.owl-stage-outer>.owl-stage>.owl-item .item .plans-title')[index]).text();
    //    console.log($itemTitle);
    if ($(window).width() > 749) {
      $(this).text('Пакет «' + $itemTitle + '»');
  ...
  if ($(window).width() < 748) {
    $('.owl-dot').show();
      $('.owl-dot.active').hide();
    containerCarousel.on('changed.owl.carousel', function (event) {
